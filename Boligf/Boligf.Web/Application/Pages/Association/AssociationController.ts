module Boligf {
	...
	export class AssociationController {
		...
		constructor(
			...
			associationMemberService.getAll().then((members: AssociationMember[]) => {
				console.log(members);
			});

			associationMemberService.getSingle("fd76fe33-e015-420a-92c4-41da4b6a6b9e").then((member: AssociationMember) => {
				console.log(member);
			});
		}
	}
